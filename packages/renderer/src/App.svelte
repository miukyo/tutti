<script lang="ts">
  ...
  let isFloatingLyricsWindow = $derived(
    window.location.hash === "#/floating-lyrics",
  );
              ...
              <div>
                ...
                >
                      ...
                      onclick={() =>
                        (player.activeSidebar =
                          player.activeSidebar === "listen-together"
                            ? "none"
                            : "listen-together")}
                      class="relative {player.activeSidebar ===
                      'listen-together'
                        ? 'text-primary'
                        : ''}"
                  ...
                  <Button
                    ...
                    class={player.activeSidebar === "queue"
                      ? "text-primary"
                      : ""}><ListIcon /></Button
                  >
                </ButtonGroup.Root>
