...
<section class="w-screen h-screen">
  <Resizable.PaneGroup direction="horizontal" autoSaveId="layout:main">
    ...
    >
      <div class="flex flex-col p-2 gap-2 h-full relative overflow-visible">
        <SearchInput />
        ...
        <div class="absolute flex justify-between p-2 z-100 w-full">
          <div class="flex gap-1 items-center">
            <Button
              ...
              ><EllipsisIcon class="size-6" /></Button
            >
            <ButtonGroup.Root
          ...
          <div>
            ...
            >
              ...
              <Button
                ...
                class={player.activeSidebar === "lyrics" ? "text-primary" : ""}
                ><MicVocalIcon /></Button
              >
              <div class="w-[2px] h-4 my-auto bg-border"></div>
              <Button
        ...
        <div class="size-full overflow-hidden relative">
          {#if activeSidebar === "queue"}
            ...
            <ScrollArea class="flex-1 min-h-0 pr-2 h-full">
              <div class="h-12"></div>
              {#if queue.length > 0}
                <SongTable songs={queue} showHeader={false} showTime={false} />
              {:else}
